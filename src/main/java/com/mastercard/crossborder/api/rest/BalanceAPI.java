...
public class BalanceAPI {
    ...
    public List<Account> getAllAccountsBalances(HttpHeaders headers, Map<String, Object> requestParams) throws ServiceException {
        ...
        return (List<Account>) restClientService.service(GET_ALL_ACCOUNTS_BALANCES, headers, HttpMethod.GET, requestParams,null, List.class);
    ...
    public Account getAcctBalanceById(HttpHeaders headers, Map<String, Object> requestParams) throws ServiceException {
        ...
        return (Account) restClientService.service(GET_ACCOUNT_BALANCE_BY_ID, headers, HttpMethod.GET, requestParams,null, Account.class);
    }
    public List<Account>  getAllAccountsBalancesWithEncryption(HttpHeaders headers, Map<String, Object> requestParams) throws ServiceException {
        ...
        return (List<Account>) restClientService.serviceEncryption(GET_ALL_ACCOUNTS_BALANCES, headers, HttpMethod.GET, requestParams, null, List.class);
    }
    public Account getAcctBalanceByIdWithEncryption(HttpHeaders headers, Map<String, Object> requestParams) throws ServiceException {
        ...
        return (Account) restClientService.serviceEncryption(GET_ACCOUNT_BALANCE_BY_ID, headers, HttpMethod.GET, requestParams,null, Account.class);
    }
